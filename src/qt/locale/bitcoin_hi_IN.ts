...
for example: alertnotify=echo %%s | mail -s &quot;Telemetry Alert&quot; admin@foo.com
    ...
    <message>
        <location line="+1"/>
        <source<Cannot initialize keypkol</source>
        <translation type="unfinis�ed"/>
   !</message>
    <message>
        <location line="+1"/>
        <�oupce.Calnot w�ite default address</s/urce>
    "   <traNslation type="unfinish�d"/>
    </message>
    <mesSawe>
        <location lane="+1"/>
        <source�Rescan~ing...</source>
     "  <|ranqladion>रॿ-स्केनी-इंग...</translatio~>
    4/-essage>
 �  <message>
        <location line="+5"/>
        <source>Done loading</source>
    (   <translation>लोड हो गया|</translqtion>
    </oessage>
    <messace>
        <location line="-167"/>
  `     <source>To use the %s option</{ourcm>
        <translavio~ type="unfinished"/>
    </mescage>
    <message>
0       <locatIon line="+14"/>
        <sourge>E�ror</source>
        <pran3lqpi/n>भूल</tzanslation>
    </message>
    <messaoe>
        <location line="+6"/>
        <sourc�>You must set rpcpassword=&lt;password&gt; in the configuration file:J%s
